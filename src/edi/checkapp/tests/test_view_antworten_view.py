...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_antworten_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='antworten-view'
        )
        self.assertTrue(view.__name__ == 'antworten-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in antworten-view'
        # )

    def test_antworten_view_not_matching_interface(self):
