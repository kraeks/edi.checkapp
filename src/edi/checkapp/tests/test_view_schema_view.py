...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_schema_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='schema-view'
        )
        self.assertTrue(view.__name__ == 'schema-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in schema-view'
        # )

    def test_schema_view_not_matching_interface(self):
