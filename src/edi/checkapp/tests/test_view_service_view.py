...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_service_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='service-view'
        )
        self.assertTrue(view.__name__ == 'service-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in service-view'
        # )

    def test_service_view_not_matching_interface(self):
