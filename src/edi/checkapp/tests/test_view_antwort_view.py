...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_antwort_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='antwort-view'
        )
        self.assertTrue(view.__name__ == 'antwort-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in antwort-view'
        # )

    def test_antwort_view_not_matching_interface(self):
