...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_frage_ansicht_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='frage-ansicht'
        )
        self.assertTrue(view.__name__ == 'frage-ansicht')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in frage-ansicht'
        # )

    def test_frage_ansicht_not_matching_interface(self):
