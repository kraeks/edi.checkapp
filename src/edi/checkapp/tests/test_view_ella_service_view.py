...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_ella_service_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='ella-service-view'
        )
        self.assertTrue(view.__name__ == 'ella-service-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in ella-service-view'
        # )

    def test_ella_service_view_not_matching_interface(self):
