...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_test_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='test-view'
        )
        self.assertTrue(view.__name__ == 'test-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in test-view'
        # )

    def test_test_view_not_matching_interface(self):
